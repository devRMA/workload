      ...
      >
        ...
        <div className="space-y-8">
          <div className="flex items-center gap-4">
            ...
            <h2 id="privacy-settings-title" className="text-2xl font-black tracking-tight">
              Privacidade
            </h2>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex min-h-11 items-center justify-between gap-4 p-4 rounded-2xl bg-neutral-100 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-800">
              ...
              <div className="flex shrink-0 items-center gap-3">
                <p className="text-xs font-bold text-indigo-600 dark:text-indigo-400">Sempre ativo</p>
                <div aria-hidden="true" className="h-6 w-11 rounded-full bg-indigo-500 flex items-center px-1">
            ...
            <div className="flex items-center justify-between gap-4 p-4 rounded-2xl bg-neutral-100 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-800">
              <div className="space-y-1">
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400">Ajuda a entender como o site é usado.</p>
              </div>
              <button
                type="button"
                role="switch"
              ...
              >
                <span
                  className={`h-6 w-11 rounded-full transition-colors flex items-center px-1 ${
                    telemetryEnabled ? "bg-indigo-500" : "bg-neutral-300 dark:bg-neutral-700"
                  }`}
                >
                  <motion.span
          ...
          <Button onClick={() => saveConsent(telemetryEnabled)} className="w-full h-14 text-lg font-bold">
            Salvar Preferências
          </Button>
        </div>
      </ModalDialog>
