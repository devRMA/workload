...
export function DurationRow({ icon: Icon, iconClassName, label, minutes }: DurationRowProps) {
  return (
    <div className="flex items-center justify-between">
      ...
      <span className="font-bold tabular-nums">{formatHoursAndMinutes(minutes)}</span>
    </div>
  );
}
