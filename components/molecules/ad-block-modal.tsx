    ...
    >
      ...
      <div className="space-y-8 text-center">
        <div className="relative mx-auto flex h-20 w-20 items-center justify-center">
          <div aria-hidden="true" className="absolute inset-0 animate-pulse rounded-full bg-indigo-500/20" />
          <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-indigo-500/10 text-indigo-600 dark:text-indigo-400">
            <Heart size={32} aria-hidden="true" className="fill-indigo-500/20" />
          </div>
        </div>

        <div className="space-y-3">
          <h2 id="ad-block-modal-title" className="text-3xl font-black tracking-tight">
            Opa! Uma ajudinha?
          </h2>
        ...
        <div className="rounded-2xl bg-neutral-100 dark:bg-neutral-800/50 p-6 text-left border border-indigo-500/10">
          <div className="flex items-start gap-4">
            <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white dark:bg-neutral-950 shadow-sm">
              <ShieldAlert size={20} aria-hidden="true" className="text-indigo-600 dark:text-indigo-400" />
            </div>
        ...
        <div className="flex flex-col gap-4 pt-2">
          <Button onClick={onConfirm} className="h-12 text-base font-bold shadow-lg shadow-indigo-500/20 gap-2">
