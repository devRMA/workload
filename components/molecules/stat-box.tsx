    ...
    <div
      className={cn(
        "rounded-2xl border p-4 flex flex-col gap-1",
        {
          ...
          "bg-amber-50/50 border-amber-100 dark:bg-amber-900/10 dark:border-amber-800": variant === "warning",
          "bg-red-50/50 border-red-100 dark:bg-red-900/10 dark:border-red-800": variant === "danger",
          "bg-purple-50/50 border-purple-100 dark:bg-purple-900/10 dark:border-purple-800": variant === "purple",
        },
        className,
      )}
      {...props}
