...
export function ModalDialog({ isOpen, onClose, labelledBy, className, children }: ModalDialogProps) {
    ...
    >
      {isOpen && (
        <motion.div
          ...
          className={cn("relative max-h-full overflow-y-auto overscroll-contain", className)}
        >
          {children}
        </motion.div>
      )}
