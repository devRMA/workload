...
export interface MaskedInputProps extends Omit<InputProps, "value" | "onChange" | "onBlur"> {
  value: string;
  separator: string;
...
export function MaskedInput({ value, separator, groupSizes, isValid, onCommit, ...inputProps }: MaskedInputProps) {
  ...
  return (
    <Input type="text" inputMode="numeric" value={text} onChange={handleChange} onBlur={handleBlur} {...inputProps} />
  );
}
