...
|---|---|---|---|---|
| spec | product-manager | pending | 0 | `spec.md` |
| design | product-designer | pending | 0 | `design.md` |
| copy | content-writer | pending | 0 | `copy.md` |
...
<Raised by any agent that cannot proceed. Empty when none.>
