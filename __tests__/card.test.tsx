...
describe("CardHeader", () => {
  ...
  it("merges custom className", () => {
    const { container } = render(<CardHeader className="my-custom">header</CardHeader>);
    expect(container.firstElementChild?.className).toContain("my-custom");
  });
});
...
describe("CardTitle", () => {
  it("renders its children as an h3", () => {
    const { container, getByText } = render(<CardTitle>title content</CardTitle>);
  ...
  it("merges custom className", () => {
    const { container } = render(<CardTitle className="my-custom">title</CardTitle>);
...
describe("CardContent", () => {
  ...
  it("merges custom className", () => {
    const { container } = render(<CardContent className="my-custom">content</CardContent>);
    expect(container.firstElementChild?.className).toContain("my-custom");
  });
});
