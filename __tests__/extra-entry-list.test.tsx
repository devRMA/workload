...
describe("ExtraEntryList", () => {
  it("renders its title, its entries and the add action", () => {
    ...
    expect(screen.getByRole("button", { name: "Adicionar desconto" })).toHaveTextContent("Adicionar");
    expect(document.getElementById("extra-deductions-list")).toContainElement(screen.getByText("Plano de Saúde"));
  });
