...
describe("VideoAdModal", () => {
  ...
  it("keeps the dialog closed and empty when isOpen is false", () => {
    const { container } = render(<VideoAdModal isOpen={false} onClose={mockOnClose} onComplete={mockOnComplete} />);
  ...
  it("closes when the native close event fires on the alert step", () => {
    const { container } = render(<VideoAdModal isOpen={true} onClose={mockOnClose} onComplete={mockOnComplete} />);
  ...
  it("renders the alert step with the start video CTA", () => {
    render(<VideoAdModal isOpen={true} onClose={mockOnClose} onComplete={mockOnComplete} />);
